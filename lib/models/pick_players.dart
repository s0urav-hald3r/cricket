...
class FantasyPoints {
  ...
  FantasyPoints.fromJson(Map<String, dynamic> json) {
    ...
    recent = json['recent'] != null ? Overall.fromJson(json['recent']) : null;
...
class Match {
  ...
  Match.fromJson(Map<String, dynamic> json) {
    ...
    lastBall =
        json['last_ball'] != null ? LastBall.fromJson(json['last_ball']) : null;
    format = json['format'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (lastBall != null) {
      data['last_ball'] = lastBall!.toJson();
    }
    data['format'] = format;
...
class LastBall {
  ...
  LastBall({this.battingTeam, this.innings, this.overStr});

  LastBall.fromJson(Map<String, dynamic> json) {
    battingTeam = json['batting_team'];
    innings = json['innings'];
    overStr = json['over_str'];
  }
...
class Players {
  ...
  Players({this.cricketer});

  Players.fromJson(Map<String, dynamic> json) {
    cricketer = <Cricketer>[];
    json.forEach((key, value) {
      cricketer!.add(Cricketer.fromJson(value));
    });
  }
}
